    ...
    <>
      ...
      <LoadedWrapper isFullyLoadedImage>
        <PageWrapper>
          ...
          <PageBanner
            textAlign='left'
            goldText={'Terms and Conditions'}
            bgText={'Terms'}
            small
          />
          <ContainerCustom>
            <MainText style={{ textAlign: 'left' }}>
              <p>Welcome to Golden Ratio Films!</p>

              <p>
                These terms and conditions outline the rules and regulations for
                the use of Golden Ratio Films's Website, located at
                http://goldenratiofilms.com/.
              </p>

              <p>
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use Golden Ratio Films if you do
              ...
              <p>
                We employ the use of cookies. By accessing Golden Ratio Films,
                you agreed to use cookies in agreement with the Golden Ratio
                Films's Privacy Policy.{' '}
              </p>
              ...
              <p>
                Unless otherwise stated, Golden Ratio Films and/or its licensors
                own the intellectual property rights for all material on Golden
                Ratio Films. All intellectual property rights are reserved. You
                may access this from Golden Ratio Films for your own personal
                use subjected to restrictions set in these terms and conditions.
              </p>

              <p>You must not:</p>
              <ul>
                <li>Republish material from Golden Ratio Films</li>
                <li>
                  Sell, rent or sub-license material from Golden Ratio Films
                </li>
                <li>
                  Reproduce, duplicate or copy material from Golden Ratio Films
                </li>
                <li>Redistribute content from Golden Ratio Films</li>
              </ul>
              ...
              <p>
                ...
                website. Golden Ratio Films does not filter, edit, publish or
                review Comments prior to their presence on the website. Comments
                do not reflect the views and opinions of Golden Ratio Films,its
                agents and/or affiliates. Comments reflect the views and
                opinions of the person who post their views and opinions. To the
                extent permitted by applicable laws, Golden Ratio Films shall
              ...
              <p>
                Golden Ratio Films reserves the right to monitor all Comments
              ...
              <p>
                You hereby grant Golden Ratio Films a non-exclusive license to
              ...
              <p>
                ...
                of Golden Ratio Films; and (d) the link is in the context of
              ...
              <p>
                ...
                by sending an e-mail to Golden Ratio Films. Please include your
              ...
              <p>
                No use of Golden Ratio Films's logo or other artwork will be
